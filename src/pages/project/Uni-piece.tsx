...
const Unipiece = () => {
  ...
  const desc = "An E-commerce online marketplace, focusing on local handcrafted product and artist";
  const img =
    "https://user-images.githubusercontent.com/80626616/200284360-bf0be878-b53c-4f25-9233-20187a964903.gif";

  const features = ["User system", "Marketplace Explore", "Artist Profile", "Product Detail"];
